...
import { uploadCommunityVideo } from "../../Configs/multerStorageConfig.js";
import {
  getCommunityModuleVideos,
  addCommunityModuleVideo,
  uploadCommunityModuleVideo,
...
router.post("/:moduleId/videos/upload", verifyToken, requireRole("admin", "csa_chair", "dance_chair", "dance_vice_chair", "choir_chairperson", "choir_vice_chair"), uploadCommunityVideo.single("video"), uploadCommunityModuleVideo);
