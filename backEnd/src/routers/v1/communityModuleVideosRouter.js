...
router.get("/:moduleId/videos/signature", verifyToken, requireRole("admin", "csa_chair", "dance_chair", "dance_vice_chair", "choir_chairperson", "choir_vice_chair"), getUploadSignature);
router.post("/:moduleId/videos/save-upload", verifyToken, requireRole("admin", "csa_chair", "dance_chair", "dance_vice_chair", "choir_chairperson", "choir_vice_chair"), saveUploadedVideo);
