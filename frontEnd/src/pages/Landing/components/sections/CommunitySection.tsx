    ...
    <section className="bg-white py-12 md:py-20 border-t border-gray-100">
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8" id='explore'>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 lg:gap-8">
          {/* Jumuiya */}
          <div className="group bg-gray-50 p-4 md:p-6 rounded-xl shadow-sm hover:shadow-xl hover:bg-white transition-all duration-300 border border-transparent hover:border-gray-100 flex flex-col items-center text-center">
