...
import { FaInfoCircle, FaUserTie, FaUsers, FaCalendarAlt, FaDatabase, FaBell } from 'react-icons/fa';
import './Admin.css';
...
const tabs = [
    ...
    { path: '/admin/database-registration', label: 'Database', icon: <FaDatabase /> },
