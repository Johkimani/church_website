...
import { FaInfoCircle, FaUserTie, FaUsers, FaCalendarAlt, FaBell, FaUserGraduate } from 'react-icons/fa';
...
type AdminTab = 'notifications' | 'about' | 'officials' | 'members' | 'registered' | 'activities';
