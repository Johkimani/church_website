          ...
          {Object.entries(groupedBookings).length > 0 && (
            <div className="px-6 py-4 bg-gradient-to-r from-slate-50 to-slate-100 border-b border-slate-200">
              <h3 className="text-base font-bold text-slate-800 mb-1">
                {groupedBookings[Object.keys(groupedBookings)[0]].activity_name}
              </h3>
              <p className="text-sm text-slate-600">
                <span className="font-medium">Type:</span> {groupedBookings[Object.keys(groupedBookings)[0]].activity_type} |
                <span className="font-medium ml-2">Total Bookings:</span> {groupedBookings[Object.keys(groupedBookings)[0]].bookings.length}
              </p>
            </div>
          )}
          <div className="overflow-x-auto">
