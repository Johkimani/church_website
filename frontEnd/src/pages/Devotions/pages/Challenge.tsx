  ...
  if (status === "loading") {
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#FAF8F5]">
        <div className="text-stone-500 text-sm italic">Loading this week's challenge...</div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen flex items-center justify-center px-6">
        <div className="w-full max-w-xl p-8 text-center">
          ...
          <h2 className="text-2xl font-bold text-stone-900 mb-2">No Active Challenge This Week</h2>
        ...
        <div className="min-h-screen flex items-center justify-center px-4 sm:px-6">
          <div className="w-full max-w-4xl p-8 sm:p-10 relative overflow-hidden text-center">
            <div className="relative z-10">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-amber-500/10 border border-amber-500/30 text-amber-700 text-[10px] font-black uppercase tracking-widest mb-4">
      ...
      <div className="min-h-screen flex items-center justify-center px-4">
        <div className="w-full max-w-2xl p-6">
          <div className="flex justify-between items-center mb-4">
            ...
            <span className="px-3 py-1 text-sm rounded-full bg-amber-500/10 text-amber-700 font-semibold">
              {challenge?.topic || "Weekly Challenge"}
            </span>
          </div>
          ...
          <div className="flex items-center gap-5">
            ...
            <div>
              ...
              <h2 className="text-3xl sm:text-4xl font-black text-stone-900 tracking-tighter leading-none mb-1">
                Score: {score}
                <span className="text-stone-500">/{questions.length}</span>
              </h2>
              <p className="text-[10px] font-bold text-stone-500 uppercase tracking-[0.2em] italic">
                Know the Church
              </p>
            </div>
          </div>
            ...
            return (
              ...
              >
                <div className="flex items-center gap-3 mb-6">
                  <span className="text-xs font-black text-stone-500 italic tracking-tighter">
                    QUESTION {String(i + 1).padStart(2, "0")}
                  </span>
                  <div className={`h-[1px] flex-1 ${isRecorded && isCorrect ? "bg-green-500/30" : "bg-stone-200"}`} />
                    ...
                    return (
                      <div key={idx} className="flex items-start gap-4 group">
                        ...
                        <div className="flex flex-col">
                          ...
                          {isCorrectAnswer && (
                            <span className="text-[8px] font-black text-green-600 uppercase tracking-widest mt-1">
                              Correct Answer
                            </span>
                          )}
                          {isUserChoice && !isCorrect && isRecorded && (
                            <span className="text-[8px] font-black text-red-600 uppercase tracking-widest mt-1">
                              Your Selection
                            </span>
                          )}
                        </div>
