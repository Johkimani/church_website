    ...
    <div className="min-h-screen w-full max-w-full flex flex-col items-center bg-transparent px-3 pt-4 pb-16">
      ...
      <header className="w-full shrink-0 flex flex-col items-center space-y-2 mb-2">
        <div className="flex flex-wrap gap-2 justify-center px-2">
          <span className="text-[10px] font-black text-stone-500 uppercase tracking-widest self-center mr-1 italic">Devotion</span>
      ...
      <div className="w-full text-center shrink-0 mb-1">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white text-stone-600 text-[10px] font-extrabold uppercase tracking-widest border border-stone-200">
        ...
        <div className="h-[36px] flex flex-col justify-center px-4 mt-1">
          <p className="text-xs sm:text-sm font-serif italic text-stone-600 leading-tight line-clamp-2">
            "{message}"
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 w-full flex items-center justify-center min-h-0 relative overflow-hidden">
        <div className="w-full h-full flex items-center justify-center p-1">
          ...
          >
            ...
            <circle cx="200" cy="180" r="150" fill="none" stroke="#A8A29E" strokeWidth="1" strokeDasharray="4,6" className="opacity-40" />
      ...
      <div className="w-full shrink-0 flex justify-center px-8 pb-4 mb-2">
        <div className="flex gap-4 w-full max-w-sm">
          <button
            ...
            className="flex-1 bg-white border border-stone-200 text-stone-600 py-4 rounded-full font-black shadow-sm active:scale-95 disabled:opacity-30 transition-all text-[11px] uppercase tracking-widest"
          >
            Back
          </button>
          <button
